...
class Login_Page:
    ...
    def enter_to_v1(self):
        return self.driver.find_element(By.XPATH, "//*[@id='login-register-modal']/div/div[8]/div[2]/p").text

    def enter_to_v2(self):
        return self.driver.find_element(By.XPATH, "//*[@id='login-register-modal']/div/div[10]/div[1]/p").text

    def enter_to_v3(self):
        return self.driver.find_element(By.ID, "userName-error").text

    def enter_to_v4(self):
        return self.driver.find_element(By.ID, "userName-error").text

    def enter_to_v5(self):
        return self.driver.find_element(By.XPATH, "//*[@id='login-register-modal']/div/div[10]/div[1]/p").text

    def enter_to_v6(self):
        self.driver.switch_to.window(self.driver.window_handles[0])
        time.sleep(5)
