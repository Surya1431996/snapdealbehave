...
class Itemcheckout_page:
    ...
    def valid_product1(self, productname):
    ...
    def enter_to_register_page1(self):
    ...
    def enter_to_emailfield1(self, email):
        self.driver.switch_to.window(self.driver.window_handles[1])
        time.sleep(2)
    ...
    def enter_to_next1(self):
        self.driver.find_element(By.XPATH, self.cont_xpath).click()
        time.sleep(5)

    def enter_to_passwordfield1(self, password):
        self.driver.switch_to.window(self.driver.window_handles[1])
        time.sleep(2)
        self.driver.find_element(By.NAME, self.pass_name).send_keys(password)
        time.sleep(2)

    def enter_to_passnext1(self):
        self.driver.find_element(By.XPATH, self.pcont_xpath).click()
        time.sleep(5)
    ...
    def enter_to_sigin_page1(self):
        self.driver.find_element(By.XPATH, self.signin_link_xpath).click()
        time.sleep(3)

    def enter_to_emailfield11(self, email):
        self.driver.switch_to.window(self.driver.window_handles[1])
        time.sleep(2)
        self.driver.find_element(By.ID, self.username_id).click()
        self.driver.find_element(By.ID, self.username_id).send_keys(email)
    ...
    def enter_to_next12(self):
        self.driver.find_element(By.XPATH, self.cont_xpath).click()
        time.sleep(5)

    def enter_to_passwordfield12(self, password):
        self.driver.switch_to.window(self.driver.window_handles[1])
        time.sleep(2)
        self.driver.find_element(By.NAME, self.pass_name).send_keys(password)
        time.sleep(2)

    def enter_to_passnext12(self):
        self.driver.find_element(By.XPATH, self.pcont_xpath).click()
        time.sleep(5)
