...
class Registration_Page:
    ...
    def enter_to_verify_valid_text(self):
        return self.driver.find_element(By.XPATH, "//*[@id='login-register-modal']/div/div[10]/div[2]/p").text

    def enter_to_verify_valid_text1(self):
        return self.driver.find_element(By.ID, "userName-error").text

    def enter_to_verify_valid_text2(self):
        return self.driver.find_element(By.XPATH, "//*[@id='login-register-modal']/div/div[8]/div[2]/p").text

    def enter_to_verify_valid_text3(self):
        return self.driver.find_element(By.ID, "j_number-error").text

    def enter_to_verify_valid_text4(self):
        return self.driver.find_element(By.ID, "signup-message").text

    def enter_to_verify_valid_text5(self):
        return self.driver.find_element(By.ID, "j_name-error").text

    def enter_to_verify_valid_text6(self):
        return self.driver.find_element(By.ID, "j_password-error").text